                                ...
                                <form class="row g-2">
                                    ...
                                    <div class="col-auto">
                                        ...
                                        <a href="{{ route('banner.create') }}" class="btn btn-primary"><i
                                                class="fa-solid fa-plus me-1"></i> Add Banner</a>
                                    </div><!--end col-->
                                </form>
                            </div><!--end col-->
                        </div><!--end row-->
                                    ...
                                    @if ($rows)
                                        ...
                                        @foreach ($rows as $row)
                                            <tr>
                                                <td>{{$i++}}</td>
                                                <td>
                                                    <img src="{{ asset("storage/".$row->image) }}" alt="" class="avatar avatar-md rounded-circle" width="40px" height="40px">
                                                </td>
                                                <td>{{ $row->name }}</td>
                                                <td class="text-end d-flex justify-content-end gap-1">
                                                    ...
                                                    @if ($row->is_superadmin == 0)
                                                        ...
                                                        @csrf
                                                        @method('DELETE')
                                                        <button class="btn_delete" type='submit' onclick="confirm('ចង់លុបមែនទេ?')"><i
